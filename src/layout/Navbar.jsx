                    ...
                    <div className="hidden md:ml-10 md:flex md:space-x-8 text-secondary transition-colors dark:text-gray-50">
                        {navItems.map((item, index) => (
                            <NavLink
                                key={index}
                                to={item.path}
                                className={`inline-flex items-center px-1 pt-1 border-b-2 text-base font-medium transition duration-300 border-transparent hover:text-primary`}
                            >
                                {item.name}
                            </NavLink>
                        ))}
                            ...
                            {navItems.map((item, index) => (
                                ...
                                >
                                    <NavLink
                                        to={item.path}
                                        className={
                                            `block px-3 py-2 rounded-md text-base font-medium transition duration-300   hover:text-secondary 
                                            }`
                                        }
